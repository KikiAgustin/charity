    ...
    <div class="container">
        <div class="xs-heading xs-mb-70 text-center">
            <h2 class="xs-mb-0 xs-title">
                We’ve funded <span>120,00 charity projects</span> for <br /> 20M
        ...
        <div class="row">
            <div class="col-md-6 col-lg-3">
                <div class="xs-service-promo">
                    ...
                    <p>
                        663 million people drink dirty water. Learn how access
                        to clean water can improve health, boost local
                        economies.
                    </p>
                </div>
